<template>
    <select name="border-radius-picker" id="border-radius-picker" v-model="borderRadius" class="p-2 lg:w-64 w-full text-lg focus:outline-none focus:ring-4 bg-white border focus:bg-gray-50" placeholder="Border kenar ayarını seçiniz.">
...
export default {
    ...
    watch:{
        borderRadius(newVal){
            this.$emit('setBorderRadius',newVal)
        }
    }
}
</script>
