<template>
    <select name="text-picker" id="text-picker" v-model="textSize" class="p-2 lg:w-64 w-full text-lg focus:outline-none focus:ring-4 bg-white border focus:bg-gray-50">
